...
interface PreferencesService<T : Any> {
    ...
    /**
     * Read the current preferences. If the preferences need to be loaded from disk, the result could be null.
     */
    fun getCurrentPreferences(): T?

    /**
     * Read the current preferences. If the preferences needed to be loaded from disk and the result was null, default preferences are written to disk and returned.
     */
